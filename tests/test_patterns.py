...
class TestPatterns(unittest.TestCase):
    ...
    def test_match_pattern_wildcard2(self):
        self.assertEqual(
            match_pattern("(is/Pd hyperbase/Cp.s great/C)", "(is/Pd hyperbase/Cp.s *)"),
            [{}],
        )
    ...
    def test_match_pattern_open_ended4(self):
        self.assertEqual(
            match_pattern("(is/Pd hyperbase/Cp.s great/C)", "(is/Pd .OBJ ...)"),
    ...
    def test_match_pattern_argroles_optionals1(self):
        self.assertEqual(
            match_pattern("(is/Pd.sc hyperbase/Cp.s great/C)", "(is/Pd.{sc,x} X Y Z)"),
    ...
    def test_match_pattern_fun_atoms4(self):
        ...
        edge = hedge(s)
        self.assertEqual(
            match_pattern(edge, pattern), [{"VERB": hedge("says/Pd.rr.|f--3s-/en")}]
        )
    ...
    def test_match_pattern_fun_any5(self):
        ...
        edge = hedge(s)
        self.assertEqual(
            match_pattern(edge, pattern), [{"X": hedge("(is/P.sc he/Ci nice/Ca)")}]
        )
    ...
    def test_match_pattern_real_case1(self):
        ...
        matches = match_pattern(edge, pattern)
        self.assertEqual(
            matches, [{"ORIG": hedge("he/Ci/en"), "TARG": hedge("macy/Cp.s/en")}]
        )
    ...
    def test_common_pattern_repeated_vars_1(self):
        ...
        self.assertEqual(
            common_pattern(edge1, edge2),
            hedge("((var is/P.{sc} X) (var (*/M name/C) X) (var */C Z))"),
        )
    ...
    def test_merge_edges4(self):
        ...
        self.assertEqual(
            merge_patterns(edge1, edge2),
            hedge("(likes/P.{so} */C (of/B.ma games/C */R))"),
        )
